...
<head>
    ...
    <title>${msg("subject.name.new_credentials")}</title>
                                    ...
                                    <td valign="top" class="bodyContent"
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr mc:repeatable="repeat_1" mc:repeatindex="0"
                                                mc:hideable="hideable_repeat_1_1" mchideable="hideable_repeat_1_1">
                                                <td valign="top" style="border-collapse: collapse;">
                                                        ...
                                                        <tr>
                                                            <td valign="top" style="border-collapse: collapse;">
                                                                <div style="color: #505050;font-family: Arial;font-size: 14px;line-height: 150%;text-align: left;">
                                                                    <h1 class="h1"
                                                                        style="color: #202020;display: block;font-family: Arial;font-size: 34px;font-weight: bold;line-height: 100%;margin-top: 0;margin-right: 0;margin-bottom: 10px;margin-left: 0;text-align: left;">
                                                                        ${msg("account.activated.header")}</h1>
                                                                </div>
                                                                <img src="http://gallery.mailchimp.com/653153ae841fd11de66ad181a/images/transparent.gif"
                                                                     alt="" border="0"
                                                                     style="margin: 0;padding: 0;border: 0;height: auto;line-height: 100%;outline: none;text-decoration: none;display: inline;">
                                                                ...
                                                                <div style="color: #505050;font-family: Arial;font-size: 14px;line-height: 150%;text-align: left;">
                                                                    ...
                                                                    ${msg("dear")} <#if person.name??>${person.name}<#else>user</#if></h4>
                                                    ...
                                                    <table style="border-radius: 5px 5px 5px 5px;background-color: #6DC4E5;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;"
                                                        ...
                                                        <tr>
                                                            <td style="font-family: Arial;font-size: 16px;padding: 15px;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;width: 160px"
                                                                ...
                                                                <a class="mcnButton " title="${msg("start.use.service")}"
                                                                   href="${link}"
                                                                   target="_self"
                                                                   style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;word-wrap: break-word !important;">${msg("start.use.service")}</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <table border="0" cellpadding="10" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td valign="top" width="350" style="border-collapse: collapse;">
                                                    <div style="color: #707070;font-family: Arial;font-size: 12px;line-height: 125%;text-align: left;vertical-align: middle;">
                                                        <em>Copyright &copy; 2013 AciertoTeam, All rights reserved.</em>
                                                    </div>
                                                </td>
                                                <td>
                                                    <img src="cid:email_logo" style="margin-left: 100px; margin-top: -15px"/>
                                                </td>
                                            </tr>
                                            <tr>
