...
public interface NotificationService {
     ...
     */
    void notifyUserAboutTakenDecisionByRequest(DecisionRequest decisionRequest);
     ...
     * @return
     */
    Collection<NotificationDTO> findNotifications(List<NotificationStatus> statuses);
